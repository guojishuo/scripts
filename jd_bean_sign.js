...
let resultPath = "/usr/local/my_project/cron_job/jd_sheep/scripts/result.txt";
let JD_DailyBonusPath = "/usr/local/my_project/cron_job/jd_sheep/scripts/JD_DailyBonus.js";
let outPutUrl = '/usr/local/my_project/cron_job/jd_sheep/scripts/utils';
